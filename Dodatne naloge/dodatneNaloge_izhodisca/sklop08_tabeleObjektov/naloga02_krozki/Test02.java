...
public class Test02 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ucenci[0].imaCasZa(krozki[2]));
        System.out.println(ucenci[0].imaCasZa(krozki[3]));
        System.out.println(ucenci[0].imaCasZa(krozki[4]));
        System.out.println(ucenci[0].imaCasZa(krozki[5]));
        System.out.println("----------");

        System.out.println(ucenci[1].imaCasZa(krozki[1]));
        System.out.println(ucenci[1].imaCasZa(krozki[2]));
        System.out.println(ucenci[1].imaCasZa(krozki[3]));
        System.out.println(ucenci[1].imaCasZa(krozki[4]));
        System.out.println("----------");

        System.out.println(ucenci[2].imaCasZa(krozki[3]));
        System.out.println(ucenci[2].imaCasZa(krozki[4]));
        System.out.println(ucenci[2].imaCasZa(krozki[5]));
    }
}
