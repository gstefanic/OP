...
public class Test05 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0;  i < krozki.length;  i++) {
            System.out.println(ucenci[0].steviloSosolcevVKrozku(krozki[i]));
            System.out.println(ucenci[1].steviloSosolcevVKrozku(krozki[i]));
            System.out.println(ucenci[2].steviloSosolcevVKrozku(krozki[i]));
            System.out.println("----------");
        }
