...
public class Test03 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ucenci[3].imaCasZa(krozki[1]));
        System.out.println(ucenci[3].imaCasZa(krozki[4]));
        System.out.println(ucenci[3].imaCasZa(krozki[5]));
        System.out.println("----------");

        System.out.println(ucenci[4].imaCasZa(krozki[0]));
        System.out.println(ucenci[4].imaCasZa(krozki[1]));
        System.out.println(ucenci[4].imaCasZa(krozki[2]));
        System.out.println(ucenci[4].imaCasZa(krozki[4]));
    }
}
